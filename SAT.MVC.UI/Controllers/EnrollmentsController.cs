...
namespace SAT.MVC.UI.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.ScheduledClassesID = new SelectList(db.ScheduledClasses, "ScheduledClassID", "InstructorName");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,StudentID,ScheduledClassesID,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewBag.ScheduledClassesID = new SelectList(db.ScheduledClasses, "ScheduledClassID", "InstructorName", enrollment.ScheduledClassesID);
