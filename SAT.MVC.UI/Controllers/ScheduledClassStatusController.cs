...
namespace SAT.MVC.UI.Controllers
{
    public class ScheduledClassStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SCSID,Name,Description,IsFull")] ScheduledClassStatus scheduledClassStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SCSID,Name,Description,IsFull")] ScheduledClassStatus scheduledClassStatus)
        {
            if (ModelState.IsValid)
            {
