...
namespace SAT.MVC.UI.Controllers
{
    public class StudentStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SSID,StatusName,Description")] StudentStatus studentStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SSID,StatusName,Description")] StudentStatus studentStatus)
        {
            if (ModelState.IsValid)
            {
